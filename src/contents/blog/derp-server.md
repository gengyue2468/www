...
date: 2026-02-22
summary: 49 元/年香港 VPS 跑 Tailscale 自建 DERP，移动友好，systemd 持久化，安全省钱。
tags: ['技术']
---
...
2026/03/10 更新：现在 Go 需要大于等于 1.26.1 的版本了....

根据[官方的最新教程](https://tailscale.com/docs/reference/derp-servers/custom-derp-servers#run-a-derp-server-from-source)现在只需要 `go install` 就可以了
...
启动 derp 服务，不过后面持久化运行还是按照创建 systemd 服务运行就行
