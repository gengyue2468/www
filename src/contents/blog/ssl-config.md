...
title: '配置一下 SSL'
date: '2026-01-19'
summary: 解决 Cloudflare 522 错误，配 Origin Certificate 和 Nginx HTTPS，发现是 ufw 没开 443。
tags: ['技术']
---

前段时间对域名在[腾讯云](https://cloud.tencent.com)上进行了一下 ICP 备案，大概过了半个月左~~右~~，然后就准备把博客从 [Vercel](https://vercel.com) 搞到闲置的轻量云服务器上，反正就是十几二十个 HTML 页面，放到服务器上 nginx 反代一配，占不了几个内存和带宽，国内速度还快不少，何乐而不为？[note:哎腾讯云控制台你说大概 12 天还真就 12 天啊，在考思政之前收到了短信...；静态资源已经美美托管到[EdgeOne](https://edgeone.ai)上了😋，参见[这篇文章](/edgeone-test)]
