...
export default function Comment() {
  ...
  return (
    <div className="px-8 xl:px-16 py-6 flex flex-col gap-4 h-full">
      <motion.h1
        initial={initial}
        animate={animate}
        transition={transition}
        className="font-extrabold text-3xl xl:text-4xl"
      >
        所有评论
      </motion.h1>

      <div className="mt-8 rounded-3xl px-4 py-4 bg-neutral-100 dark:bg-neutral-900 flex flex-col flex-1 min-h-0 gap-4 -translate-x-8 md:translate-x-0 w-[calc(100%+4rem)] md:w-full">
            ...
            <div>
              <div className="flex flex-col items-center justify-center">
                ...
                >
                  <path
                    fill="#fcc21b"
                    d="M104.22 128h13.61L99.9 68.55H86.29z"
                  />
                  <path
                    fill="#fcc21b"
                  ...
                  <path
                    fill="#fcc21b"
                    d="M24.29 128H10.46l16.12-59.45h13.83z"
                  />
                  <defs>
                    <path
                  ...
                  <g
                    fill="#2f2f2f"
                    clip-path="url(#IconifyId199f79c0405c057187)"
                  >
                ...
                <h1 className="font-extrabold text-4xl mb-4">都赶上了！</h1>
                <p className="font-bold text-xl opacity-50">我们很抱歉，但是评论目前不可用</p>
              </div>
            </div>
          )}
        </div>
      ...
      <motion.div
        ...
        animate={animate}
        transition={transition}
        className="mb-12 max-w-2xl mx-auto w-full bg-neutral-200/75 dark:bg-neutral-800/75 backdrop-blur-lg rounded-full px-4 py-3"
      >
        <div className="flex flex-row items-center gap-4">
          <img src="/static/author.webp" className="rounded-full size-12" />
          <input
            className="flex-1 placeholder:font-medium bg-neutral-100 dark:bg-neutral-900 rounded-3xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:bg-neutral-200/50 dark:focus:bg-neutral-800/50 transition-all duration-500"
            placeholder="撰写评论..."
          />
          <div>
            <button className="whitespace-nowrap bg-black dark:bg-white text-white dark:text-black rounded-3xl px-6 py-4 font-semibold focus:ring-2 focus:ring-neutral-500 transition-all duration-500">
              发送
            </button>
          </div>
        </div>
