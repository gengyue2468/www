...
export default function Share({ title }) {
  ...
  const style = {
    btn: "rounded-3xl bg-neutral-200 dark:bg-neutral-800 px-6 py-4 flex flex-col items-center justify-center",
  ...
  return (
    <div className="max-w-xs mx-auto">
      ...
      <div className="flex flex-row justify-between gap-2 mt-4">
        <button onClick={handleCopyLink} className={style.btn}>
          {copied ? (
        ...
        <button onClick={handleQQShare} className={style.btn}>
          <svg
        ...
        <button onClick={handleWeiboShare} className={style.btn}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="size-10"
            viewBox="0 0 512 512"
