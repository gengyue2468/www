export default function Login() {
  return (
    <div className="w-56 mx-auto">
      <h1 className="font-medium text-center">让我们帮助您登录</h1>

      <button className="bg-neutral-900 dark:bg-neutral-100 rounded-lg text-white dark:text-black my-2 py-2 w-full flex gap-1 items-center justify-center">
        <Fa7BrandsGithub className="size-5" /> 用 GitHub 继续
      </button>
      <p className="text-center text-sm opacity-75 mt-2 flex flex-row justify-center gap-1">
        Powered by <img src="/static/nextauth.png" className="size-5" />{" "}
        Next-Auth
      </p>
    </div>
  );
