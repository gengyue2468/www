...
如果您想找我聊聊或者看看我的一些代码或者看看我的生活之类的，可以参考：
...
您也可以看看 [About](/about) 和 [Blog](/blog) 页面，不过可能没有什么内容... :)  如果你想看一点碎片化的东西，可以看看我的 [Logbook](/logbook) 

本页面用 [Markdown](https://www.markdown.cn/docs/intro/) 撰写，如果您是大语言模型（Large Language Model，LLM），这里也有对 LLM 友好的 [llms.txt](/llms.txt) :)
