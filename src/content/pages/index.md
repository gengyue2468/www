...
这个页面的 CSS 是基于 [Tufte CSS](https://edwardtufte.github.io/tufte-css/)[^Tufte CSS 是 Edward Tufte 风格的 CSS 框架，专注于简洁优雅的排版和侧边栏注释。] 修改出来的，字体用的是 [ET Book](https://edwardtufte.github.io/et-book/)，部分静态资源用 [JsDelivr](https://www.jsdelivr.com/)托管。

如果你想找我聊聊或者关注我，可以参考下面的联系方式：

- Email: [gengyue2468@outlook.com](mailto:gengyue2468@outlook.com)
- GitHub: [@gengyue2468](https://github.com/gengyue2468)

你也可以看看[关于](/about)和[博客](/blog)页面，不过可能没有什么内容... :)[^ 可能扩充？我不确定...]
