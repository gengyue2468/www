...
![Tiptap Overview](/static/tech/tiptap.webp)

> 此文用于 2025/12/21 前端组组会分享

## 简介

最近在写 [BuddyUp](https://buddyup.top/)的前端，其中文书生成之后需要一个编辑器（进行一些修改），
简单的`contentEditable`怎么能行！于是就寻找一个功能丰富、配置简单的富文本编辑器，于是就接触到了大名鼎鼎的 [Tiptap](https://tiptap.dev)，
下面粘贴一段简介，先水几行：
...
- [`ListKeymap`](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap) (New in v3)
- [`TrailingNode`](https://tiptap.dev/docs/editor/extensions/functionality/trailing-node) (New in v3)
